        ...
        <div id="mobile-menu" className="hidden md:hidden pb-4 space-y-2">
          ...
          {isDM && (
            <div className="pt-2 mt-2 border-t border-red-900/50">
              ...
              <a href="/dm/progresso-gilde" className="block px-3 py-2 rounded-lg hover:bg-red-900/20 text-red-400 hover:text-red-300 transition-colors">
                Progresso Gilde
              </a>
          ...
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between py-2">
              ...
              <div className="flex items-center gap-6 text-sm">
                ...
                <a href="/dm/progresso-gilde" className="text-red-400 hover:text-red-300 transition-colors flex items-center gap-1">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
